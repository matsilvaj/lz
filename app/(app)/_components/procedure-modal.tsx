          ...
          <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-3xl border border-neutral-200 bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-neutral-200 px-6 py-4">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">
                  Use a logica do dominio para registrar o procedimento com consistencia.
                </p>
              </div>
            ...
            <form action={saveProcedureAction} className="space-y-6 px-6 py-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="space-y-2 text-sm">
                  <span className="font-medium text-neutral-900">Mes de referencia</span>
                  <input
                    className="w-full rounded-xl border border-neutral-300 px-3 py-2.5 outline-none transition focus:border-neutral-950"
                    defaultValue={defaultValues?.referenceMonth ?? getMonthInputValue()}
                    name="referenceMonth"
                    type="month"
                  />
                </label>
              ...
              <div className="grid gap-4 md:grid-cols-[1.1fr,0.9fr]">
                <label className="space-y-2 text-sm">
                  <span className="font-medium text-neutral-900">Lucro base</span>
                  <input
                    className="w-full rounded-xl border border-neutral-300 px-3 py-2.5 outline-none transition focus:border-neutral-950"
                ...
                <label className="flex items-center gap-3 rounded-2xl border border-neutral-200 px-4 py-3 text-sm">
                  <input
                    defaultChecked={defaultValues?.equalProfit ?? true}
                    name="equalProfit"
                    type="checkbox"
                  />
                  <span className="font-medium text-neutral-900">Lucro igual nas posicoes</span>
                </label>
              </div>

              <div className="space-y-3 rounded-2xl border border-neutral-200 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium text-neutral-900">Protecoes</p>
                  <button
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <label className="flex items-center gap-3 rounded-2xl border border-neutral-200 px-4 py-3 text-sm">
                  <input
                    defaultChecked={defaultValues?.hitDouble ?? false}
                    name="hitDouble"
                    type="checkbox"
                  />
                  <span className="font-medium text-neutral-900">Bateu duplo</span>
                </label>
              ...
              <label className="space-y-2 text-sm">
                <span className="font-medium text-neutral-900">Observacao</span>
                <textarea
                  className="min-h-28 w-full rounded-xl border border-neutral-300 px-3 py-2.5 outline-none transition focus:border-neutral-950"
                  defaultValue={defaultValues?.note ?? ""}
                  name="note"
                  placeholder="Anote aqui qualquer contexto importante"
                />
              </label>
