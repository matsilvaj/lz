...
const getCachedBookmakersPageData = unstable_cache(
  getBookmakersPageDataUncached,
  ["bookmakers-page-data"],
  {
    tags: ["bookmakers-page-data"],
    revalidate: 30,
  },
);

export async function getBookmakersPageData(userId, baseId) {
  return getCachedBookmakersPageData(userId, baseId);
}
