...
function isRepositoryCompatible(repository) {
  return Boolean(
    repository &&
      ...
      typeof repository.updateProcedureStatus === "function" &&
      typeof repository.saveFilterPreset === "function" &&
      typeof repository.setMonitorFavorite === "function" &&
      typeof repository.listTrendingMonitorFixtures === "function" &&
      typeof repository.listPartners === "function" &&
      typeof repository.deleteWorkspace === "function" &&
      typeof repository.setActiveUserSession === "function" &&
      typeof repository.isActiveUserSession === "function" &&
      typeof repository.clearActiveUserSession === "function",
  );
}
